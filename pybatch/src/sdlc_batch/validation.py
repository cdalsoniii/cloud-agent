...
class ValidationEngine:
    ...
    Supports:
      ...
      2. Formal business-rule verification via the local TypeScript validation runner.
      3. Keyword coverage heuristics only as a fallback when no validation_cmd is provided.
    """
